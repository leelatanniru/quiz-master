...
var AppComponent = /** @class */ (function () {
    function AppComponent(authService, router, flashMessage, userService) {
...
var CreateQuizSuccessComponent = /** @class */ (function () {
    function CreateQuizSuccessComponent() {
        this.quizId = localStorage.getItem('newQuizId');
    }
    CreateQuizSuccessComponent.prototype.ngOnInit = function () {
    };
    CreateQuizSuccessComponent.prototype.copy = function () {
        var _this = this;
        document.addEventListener('copy', function (e) {
            e.clipboardData.setData('text/plain', (_this.quizId));
            e.preventDefault();
    ...
    return CreateQuizSuccessComponent;
}());
...
var CreateQuizComponent = /** @class */ (function () {
    function CreateQuizComponent(router, userService, quizService) {
        this.router = router;
        this.userService = userService;
    ...
    CreateQuizComponent.prototype.isEdited = function () {
        console.log('is edited');
        console.log(this.quizForm.dirty);
        return this.quizForm.dirty;
    };
    CreateQuizComponent.prototype.isAnswerKeyValid = function () {
        return /^[1-4]+$/.test(this.quizForm.controls['answerKey'].value);
    };
    CreateQuizComponent.prototype.isValid = function () {
        console.log('isVAlid');
    ...
    CreateQuizComponent.prototype.onSubmit = function () {
    ...
    CreateQuizComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, flashMessage, router, userService) {
        this.authService = authService;
        this.flashMessage = flashMessage;
        this.router = router;
        this.userService = userService;
    ...
    function Quiz(data) {
        ...
        if (data) {
            ...
            data.questions.forEach(function (q) {
                _this.questions.push(new _question__WEBPACK_IMPORTED_MODULE_0__["Question"](q));
            });
        }
    }
...
var MyQuizesComponent = /** @class */ (function () {
    function MyQuizesComponent(quizService, router) {
        var _this = this;
        this.quizService = quizService;
        this.router = router;
        this.color = 'primary';
        ...
        this.subscription = this.quizService.getQuizes().subscribe(function (data) {
            _this.dataSource = data.filter(function (d) {
                console.log(d.time);
                console.log(_this.currentUser);
                console.log('*****');
                return d.owner == _this.currentUser;
            });
    ...
    MyQuizesComponent.prototype.getQuiz = function (row) {
        console.log('row', row.id);
        this.router.navigateByUrl('quizes/' + row.id);
    };
    MyQuizesComponent.prototype.ngOnInit = function () {
    };
    MyQuizesComponent.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
    };
    MyQuizesComponent.ctorParameters = function () { return [
...
var MyResultsComponent = /** @class */ (function () {
    function MyResultsComponent(resultService) {
        var _this = this;
        ...
        this.currentUser = localStorage.getItem('userId');
        this.subscription = this.resultService.getResultsByUser(localStorage.getItem('userId')).subscribe(function (data) {
    ...
    MyResultsComponent.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
    };
    MyResultsComponent.prototype.ngOnInit = function () {
    };
    MyResultsComponent.ctorParameters = function () { return [
...
var QuizDetailsComponent = /** @class */ (function () {
    function QuizDetailsComponent(quizService, route, router) {
        this.quizService = quizService;
        this.route = route;
        this.router = router;
    }
    QuizDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.quizService.quizDetails.subscribe(function (quiz) {
            _this.quiz = quiz;
            console.log('quiz retrived');
            console.log(_this.quiz);
        });
    };
    QuizDetailsComponent.prototype.onSubmit = function () {
        this.router.navigateByUrl('results/' + this.quiz.id);
    };
    QuizDetailsComponent.ctorParameters = function () { return [
        { type: _services_quiz_service__WEBPACK_IMPORTED_MODULE_1__["QuizService"] },
...
var QuizResultComponent = /** @class */ (function () {
    function QuizResultComponent(resultService, route, router) {
        this.resultService = resultService;
        this.route = route;
        this.router = router;
        this.color = 'primary';
    ...
    QuizResultComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.route.snapshot.params['id'];
        this.resultService.getResultsForQuiz(this.id).subscribe(function (data) {
            _this.dataSource = data;
            console.log(_this.dataSource);
        });
    };
    QuizResultComponent.ctorParameters = function () { return [
        { type: _services_result_service__WEBPACK_IMPORTED_MODULE_1__["ResultService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var QuizComponent = /** @class */ (function () {
    ...
    QuizComponent.prototype.loadQuiz = function () {
        var _this = this;
        var n = this.quizService.quiz.noOfQues;
        this.questions = [];
    ...
    ;
    QuizComponent.prototype.isCorrect = function (val) {
    ...
    QuizComponent.prototype.onSubmit = function () {
        ...
        this.score = this.evaluatedAns.filter(function (v) { return v; }).length;
        this.n = this.evaluatedAns.length;
        // this.quizService.evaluate(this.quiz.questions);
        this.mode = 'result';
        console.log('is quiz started??? ' + this.quizService.isQuizStarted());
    };
    QuizComponent.prototype.getCorrectAns = function (id) {
        return this.ans[id];
    };
...
var RegisterComponent = /** @class */ (function () {
    // public n: number;
    function RegisterComponent(authService, flashMessage, router, userService, counterService) {
        this.authService = authService;
        this.flashMessage = flashMessage;
        this.router = router;
        this.userService = userService;
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        this.authService.register(this.registerForm.controls['emailId'].value, this.registerForm.controls['password'].value)
            ...
            _this.userService.newUser(user);
...
var CounterService = /** @class */ (function () {
    function CounterService(afs) {
        this.afs = afs;
        this.countCollection = this.afs.collection('noOfUsers');
    }
    CounterService.prototype.getCount = function () {
        this.n = this.countCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (changes) {
...
var QuizGuardService = /** @class */ (function () {
    function QuizGuardService(quiz, router) {
        this.quiz = quiz;
        this.router = router;
    }
    QuizGuardService.prototype.canActivate = function (route) {
    ...
    QuizGuardService.ctorParameters = function () { return [
...
var QuizService = /** @class */ (function () {
    function QuizService(afs, router, resultService) {
        this.afs = afs;
        this.router = router;
        this.resultService = resultService;
    ...
    QuizService.prototype.getQuizes = function () {
        ...
        this.quizes = this.quizesCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (changes) {
            return changes.map(function (action) {
                var data = action.payload.doc.data();
                data.id = action.payload.doc.id;
                // console.log('data', data);
    ...
    QuizService.prototype.getQuiz = function (id) {
        ...
        this.quizDoc.snapshotChanges().subscribe(function (action) {
    ...
    QuizService.prototype.startQuiz = function (quizId) {
        var _this = this;
        ...
        this.quizDoc.snapshotChanges().subscribe(function (action) {
            if (action.payload.exists === false) {
                ...
                _this.result = [];
                for (var i = 0; i < _this.quiz.noOfQues; i++) {
                    _this.result.push(false);
                }
                _this.answers = _this.quiz.answerKey.split('');
    ...
    QuizService.prototype.newQuiz = function (quiz) {
        ...
        this.quizesCollection.add(quiz).then(function (res) {
            console.log(res);
            localStorage.setItem('newQuizId', res.id);
            console.log('navigate');
            _this.router.navigateByUrl('/create-quiz-success');
    ...
    QuizService.prototype.getResult = function () {
        ...
        res.score = this.result.filter(function (v) { return v; }).length;
    ...
    // }
    QuizService.prototype.isQuizStarted = function () {
        return this.quizStarted;
    };
    QuizService.prototype.evaluate = function (question, option) {
    ...
    QuizService.prototype.final = function () {
        console.log(this.result);
    };
    // get(url: string) {
...
var ResultService = /** @class */ (function () {
    function ResultService(afs) {
        this.afs = afs;
        this.resultCollection = this.afs.collection('results');
    }
    ResultService.prototype.getResultsForQuiz = function (id) {
        this.resultforQuizCollection = this.afs.collection('results', function (ref) { return ref.where('quizId', '==', id); });
        this.resultforUser$ = this.resultforQuizCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (changes) {
            return changes.map(function (action) {
                var data = action.payload.doc.data();
                data.id = action.payload.doc.id;
                // console.log('data', data);
    ...
    ResultService.prototype.getResultsByUser = function (userEmail) {
        console.log(userEmail);
        this.resultforUserCollection = this.afs.collection('results', function (ref) { return ref.where('user', '==', userEmail); });
        this.resultforQuiz$ = this.resultforUserCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (changes) {
            return changes.map(function (action) {
                var data = action.payload.doc.data();
                data.id = action.payload.doc.id;
                // console.log('data', data);
    ...
    ResultService.prototype.newResult = function (result) {
...
var UserService = /** @class */ (function () {
    function UserService(afs) {
        this.afs = afs;
        this.usersCollection = this.afs.collection('users', function (ref) { return ref.orderBy('lastName', 'asc'); });
        console.log(this.usersCollection);
    }
    UserService.prototype.getUsers = function () {
        // Get clients with the id
        console.log('getting users');
        this.users = this.usersCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (changes) {
            return changes.map(function (action) {
                var data = action.payload.doc.data();
                data.id = action.payload.doc.id;
                console.log('data', data);
    ...
    UserService.prototype.newUser = function (client) {
        this.usersCollection.add(client);
    };
    UserService.prototype.setLoggedInUser = function (email) {
    ...
    //   return this.user;
    // }
    UserService.prototype.updateNoofQuizes = function () {
...
var TakeQuizComponent = /** @class */ (function () {
    function TakeQuizComponent(router, quizService, flashMessage) {
        this.router = router;
        this.quizService = quizService;
        this.flashMessage = flashMessage;
    }
    ...
    TakeQuizComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
